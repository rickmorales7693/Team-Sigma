...
Variables below were renamed to improve understanding and code readability. Inserted characters such as underscores before variable names are removed. Variable names are consistent case-wise with all column names in uppercase format. Since data is already in wide format, pivoting is not needed. 
```{r}
