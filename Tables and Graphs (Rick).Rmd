...
brfss_2017 <- brfss_2017 %>%
  mutate(
    EducationGroup = case_when(
      EDUCA %in% c("Never attended/kindergarten only", "Grades 1–8", "Grades 9–11") ~ "Below High School",
      EDUCA == "High school grad/GED" ~ "High School Grad/GED",
      EDUCA == "Some college" ~ "Some College",
      EDUCA == "College graduate" ~ "College Graduate",
      TRUE ~ NA_character_
    ),
