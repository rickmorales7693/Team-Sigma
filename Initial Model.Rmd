...
```{r}
brfss_2017_cleaned
is.factor(brfss_2017_cleaned$ECIG_COMP)
```
...
Class Imbalance Check for Binary Response
```{r}
#brfss_2017_cleaned$ECIG_BINARY <- ifelse(brfss_2017_cleaned$ECIG_COMP == 1 | df$ECIG_COMP == 2, 1, 0)
```
