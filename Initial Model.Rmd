...
```{r}
x_train <- data.matrix(train[, c('AGE80', 'BMI', 'SMOKER_COMP', 'STATE', 'ADDEPEV', 'ALCDAY5',
...
# Overfitting Check
```{r}
# Rebuild x_test and make sure it's a data.frame with column names matching train_lm
x_test <- test[, colnames(train_lm)[-1]]  # -1 removes y_train
